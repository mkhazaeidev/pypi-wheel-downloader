...
def print_usage():
    print("Usage:")
    print("  python3 download_pypi_macOS.py <package_name> <output_directory>")
    sys.exit(1)
...
print("=" * 70)
print("PyPI macOS Wheel Downloader")
print("=" * 70)
...
macos_wheels = [
    ...
    and "macosx" in f["filename"]
]

print(f"Latest Version : {version}")
print(f"macOS Wheels   : {len(macos_wheels)}")
print()

if not macos_wheels:
    print("No macOS wheel files found.")
    sys.exit(0)

total = len(macos_wheels)

for index, wheel in enumerate(macos_wheels, start=1):
